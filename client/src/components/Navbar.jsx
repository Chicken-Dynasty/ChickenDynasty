...
const Navbar = () => {
    ...
    return (
        <div className=" fixed left-0 top-0 bottom-0 ">
            <div id="Main" className={`${show ? 'translate-x-0' : '-translate-x-full'} xl:rounded-r transform  xl:translate-x-0  ease-in-out transition duration-500 flex justify-start items-start h-full  w-full sm:w-64 bg-rose-900 flex-col`}>
                ...
                <div className="mt-6 flex flex-col flex-1 justify-start items-center  pl-4 w-full h-ful space-y-3 pb-5 ">
                    ...
                    <Link to ="/farm" className="mt-6 flex flex-col justify-start items-center  pl-4 w-full space-y-3 pb-5">
                    <button className="flex jusitfy-start items-center space-x-6 w-full  focus:outline-none  focus:text-pink-400  text-white rounded ">
                        ...
                        <p className="text-base leading-4 ">Farm</p>
                    </button>
                    </Link>
                    <Link to="/hatch" className="mt-6 flex flex-col justify-start items-center  pl-4 w-full space-y-3 pb-5">
                    <button className="flex jusitfy-start items-center w-full  space-x-6 focus:outline-none text-white focus:text-zinc-400   rounded ">
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        <p className="text-base leading-4 ">Hatch Egg</p>
                        
                    </button>
                    </Link>
                    <Link to="/wheat" className="mt-6 flex flex-col justify-start items-center  pl-4 w-full space-y-3 pb-5">
                    <button className="flex jusitfy-start items-center w-full  space-x-6 focus:outline-none text-white focus:text-zinc-400   rounded ">
                    <svg className ="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                        <p className="text-base leading-4 ">Buy Wheat</p>
                    </button>
                    </Link>                    

                    <button className="flex jusitfy-start items-center w-3/4  space-x-6 focus:outline-none text-white focus:text-zinc-400 rounded bg-orange-600 mr-2"  onClick={connectWallet}>
                        <svg className="fill-stroke" width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p className="text-base leading-4 ">{currentAccount? 'Connected' : 'Connect to wallet'}</p>
                    </button>   

                </div>
                <div className="flex flex-col flex-none mb-6 justify-start items-end pl-8 w-full space-y-3">
                        <button className="flex jusitfy-start items-center w-full  space-x-6 focus:outline-none text-white focus:text-zinc-400 rounded " onClick={() => {window.open('https://unn-jertjamjarat.gitbook.io/chicken-dynasty/');}}>
